...
namespace HtmlTextBlock
{
    ...
    { ltString, ltFile, ltWeb, ltWebNoCache }                  //Define where to load from.

    //public enum threeSide { _default=0, _left, _top, _right }
    public enum fourSide
    { _default = 0, _left, _top, _right, _bottom }               //Define Left, Top, Right and Bottom

    public enum hAlignType
    { Unknown, Left, Right, Centre }                         //Define visible object horizontal hAlign

    public enum vAlignType
    { Unknown, Top, Bottom }                                 //Define visible object verticial hAlign

    public enum formMethodType
    { Default, Get, Post }                               //Define form action

    public enum tagStatusType
    { Normal, Focused, Active }                           //Define state of a visile tag

    public enum selectInfoPairs
    { sStart, sEnd }                                    //Define Start and End of SelectInfo

    public enum parseMode
    { Text = 0, Html, BBCode }                          		//Parse html or bbcode
    ...
    public enum aTextStyle
    { isNormal, isSubScript, isSuperScript }                 //Define text style

    public enum loadStatus
    { Idle, Load, Update, Draw, Overlay }                    //Define what is miniHtml doing

    public enum elementType
    { eSpace, eText, eSymbol, eId, eClass, eStyle, eDash }  //Define type of a char

    public enum symbolType
    { Reserved, European, Symbol, Scientific, Shape }        //Define symbol type in BuiltInSymbols

    public enum textTransformType
    { None, Uppercase, Lowercase, Capitalize }        //Define how to transofm a text

    public enum positionStyleType
    { Static, Relative, Absolute, Fixed, Inherited }  //Define how to allocate a tag
    ...
    { Number, Alpha, String, Formated, Paragraph }         //Define variableType of variableTag (for search text)

    #endregion Enums Types
    ...
    { public bool bold, italic, regular, strikeout, underline; }
    ...
    public class Defines
    {
        ...
        public static SymbolInfo[] BuiltinSymbols = new SymbolInfo[252] {
          ...
          #region Built in Symbol list
            ...
            #endregion Built in Symbol list
       };
        ...
        public static RomanDigits[] BuiltinRomans = new RomanDigits[13]
       {
	      ...
	      #endregion Built in Romans list
       };
        ...
        public static HTMLTagInfo[] BuiltinBBCodes = new HTMLTagInfo[14] {
          ...
          #region Built in BBCode list
           ...
           #endregion Built in BBCode list
       };

        #endregion Array Consts
